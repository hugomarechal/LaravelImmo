...
@section('content')
    ...
    <form class="vstack gap-2" action="{{ route($property ? 'admin.property.update' : 'admin.property.store', ['property' => $property]) }}" method="post" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
            ...
            <div class="col">
                @include('shared.upload', ['name'=>'pictures', 'multiple' => true])
            </div>
        </div>
